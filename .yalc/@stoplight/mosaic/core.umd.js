(function (global, factory) {
  ...
  function runIfFn(valueOrFn) {
    ...
    return isFunction(valueOrFn) ? valueOrFn.apply(void 0, tslib.__spread(args)) : valueOrFn;
  }
  function once(fn) {
    var result;
  ...
  var propNames = tslib.__spread(borderPropNames, colorPropNames, flexPropNames, interactivityPropNames, layoutPropNames, positionPropNames, shadowPropNames, sizePropNames, spacingPropNames, typographyPropNames);
  /**
  ...
  var Button = React.memo(React.forwardRef(function (_a, ref) {
    var _b = _a.appearance,
        ...
        props = tslib.__rest(_a, ["appearance", "intent", "size", "disabled", "loading", "className", "icon", "iconRight", "label", "children", "active", "autoFocus"]);
    ...
    var _f = utils$1.mergeProps(matchedProps, buttonProps, hoverProps),
        color = _f.color,
        propsWithoutColor = tslib.__rest(_f, ["color"]);
  ...
  var ModalBox = React.forwardRef(function (_a, ref) {
    ...
    }), typeof title === 'string' ? React__default.createElement(Heading, tslib.__assign({
      size: 3,
      fontSize: "xl",
      flex: 1
    }, titleProps), title) : React__default.createElement(Box, tslib.__assign({}, titleProps, {
      as: "header"
  ...
  var Tab = React.memo(function (_a) {
    var _b;

    var children = _a.children,
        id = _a.id,
        disabled = _a.disabled,
        restProps = tslib.__rest(_a, ["children", "id", "disabled"]);

    var _c = useTabContext(),
        isEager = _c.isEager,
        tab = tslib.__rest(_c, ["isEager"]);
    ...
    return React.createElement(focus.FocusRing, {
      focusRingClass: "sl-focus-ring"
    }, React.createElement(Box, tslib.__assign({
      as: Tab$1.Tab,
      ref: tabRef,
      fontWeight: "medium",
  ...
  var TabList = function TabList(props) {
    var _a = useTabContext(),
        isEager = _a.isEager,
        tab = tslib.__rest(_a, ["isEager"]);

    return React.createElement(Tab$1.TabList, tslib.__assign({
  ...
  var TabPanel = React.memo(function (_a) {
    var children = _a.children,
        props = tslib.__rest(_a, ["children"]);

    var _b = useTabContext(),
        isEager = _b.isEager,
        tab = tslib.__rest(_b, ["isEager"]);
    ...
    return React.createElement(Box, tslib.__assign({
      as: Tab$1.TabPanel,
      ref: ref,
  ...
  function Select(_a) {
    ...
    var flexGrow = _a.flexGrow,
        ...
        props = tslib.__rest(_a, ["flexGrow", "w", "size", "label", "renderTrigger", "triggerTextPrefix", "items", "selectedValue", "defaultSelectedValue", "onSelectionChange", "allowEmptySelection", "placeholder", "onOpen", "onClose", "isReadOnly", "isDisabled", "children", "disabledValues"]);
    ...
    var _f = tslib.__read(useSize(triggerRef), 1),
        buttonWidth = _f[0];
  ...
  var ListBoxPopup = React.forwardRef(function (_a, ref) {
    var state = _a.state,
        ...
        label = _a.label,
        items = _a.items,
        otherProps = tslib.__rest(_a, ["state", "minW", "label", "items"]); // Get props for the listbox
    ...
    }), tslib.__spread(state.collection).map(function (item) {
      var type = item.type;
  ...
  var Section = React.memo(function (_a) {
    ...
    return React__default.createElement(React__default.Fragment, null, item.key !== state.collection.getFirstKey() && React__default.createElement(Box, tslib.__assign({}, separatorPropsWithoutColor, {
      ...
      cursor: "default",
      fontSize: "sm"
    }), item.rendered), React__default.createElement("div", tslib.__assign({}, groupProps), tslib.__spread(item.childNodes).map(function (node) {
      var item;
              ...
              return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                  ...
                  case 1:
                    ...
                    items_1 = tslib.__values(items), items_1_1 = items_1.next();
                    _b.label = 2;
  ...
  exports.SelectSection = _SelectSection;
  exports.Stack = Stack;
