import { __rest, __read, __spread, __assign, __generator, __values } from 'tslib';
import cn from 'clsx';
import copy from 'copy-to-clipboard';
import React__default, { useState, useCallback, useEffect, useRef, useImperativeHandle, forwardRef, useMemo, useContext, memo, createElement, createContext } from 'react';
import { parseToHsl, parseToRgb, rgba, getLuminance, mix, readableColor } from 'polished';
import deepmerge from 'deepmerge';
import { createDOMRef, unwrapDOMRef, useFocusableRef, useDOMRef as useDOMRef$1 } from '@react-spectrum/utils';
...
import { FocusRing, FocusScope, FocusableProvider } from '@react-aria/focus';
...
import { Tab as Tab$1, TabList as TabList$1, TabPanel as TabPanel$1, useTabState } from 'reakit/Tab';
...
var setLuminance = function setLuminance(amount, color) {
  ...
  if (amount === 0) {
    ...
    rgb = getLuminance(color) > amount ? test_1('#000', color) : test_1(color, '#fff');
  }
...
function runIfFn(valueOrFn) {
  ...
  return isFunction(valueOrFn) ? valueOrFn.apply(void 0, __spread(args)) : valueOrFn;
}
function once(fn) {
  var result;
...
var propNames = __spread(borderPropNames, colorPropNames, flexPropNames, interactivityPropNames, layoutPropNames, positionPropNames, shadowPropNames, sizePropNames, spacingPropNames, typographyPropNames);
/**
...
var WithDomRef = forwardRef(function WithDomRef(_a, ref) {
...
function useControllableProp(prop, state) {
  var isControlled = useRef(prop !== undefined).current;
...
function useControllableState(props) {
  ...
  var _c = __read(useState(defaultValue), 2),
      valueState = _c[0],
      setValue = _c[1];

  var isControlled = useRef(valueProp !== undefined).current; // don't switch from controlled to uncontrolled
  ...
  var initialDefaultValue = useRef(defaultValue).current;
  useEffect(function () {
    warn({
...
var InvertTheme = function InvertTheme(_a) {
  ...
  var parentInverted = useContext(InvertThemeContext).inverted;
  ...
  return {
    ...
    setColor: function setColor(name, val) {
      return set(function (state) {
        ...
        return {
          theme: __assign(__assign({}, state.theme), {
            colors: __assign(__assign({}, state.theme.colors), (_a = {}, _a[name] = hslString, _a))
          })
        };
      });
    },
...
var useThemeIsDark = function useThemeIsDark() {
  var inverted = useContext(InvertThemeContext).inverted;

  var _a = __read(useThemeStore(function (s) {
...
var Box = forwardRef(function Box(_a, ref) {
  ...
  return React__default.createElement(Element, __assign({
    ref: ref
  }, restProps, {
    className: _className || undefined,
    role: role
...
var Article = memo(function Article(_a) {
  ...
  return React__default.createElement(Container, __assign({
    as: "article",
    className: cn('sl-article', className),
    size: "lg",
    py: 20
  }, props), React__default.createElement(Prose, null, children));
});
...
var Icon = memo(function Icon(_a) {
  ...
  if (isIconDefinition(iconProp) || findIconDefinition(iconProp)) {
    return React__default.createElement(FontAwesomeIcon, __assign({
  ...
  return React__default.createElement("i", {
    role: "img",
    "aria-hidden": "true",
    className: cn(_className, iconProp.prefix, "fa-" + iconProp.iconName, (_b = {
      'fa-spin': props.spin,
...
var Avatar = memo(forwardRef(function Avatar(props, ref) {
  ...
  return React__default.createElement(Flex, __assign({
    ref: ref,
...
var Button = memo(forwardRef(function (_a, ref) {
  var _b = _a.appearance,
      ...
      props = __rest(_a, ["appearance", "intent", "size", "disabled", "loading", "className", "icon", "iconRight", "label", "children", "active", "autoFocus"]);

  var buttonProps = useButton(__assign({
    isDisabled: disabled
  }, props), ref).buttonProps;
  var hoverProps = useHover(__assign({
    isDisabled: disabled
  }, props)).hoverProps;
  var matchedProps = splitBoxProps(props).matchedProps;

  var stateProps = __assign(__assign(__assign(__assign({}, variants["default"]["default"]), variants["default"][intent]), variants[appearance]["default"]), variants[appearance][intent]);
  /**
    ...
    for (var i in stateProps) {
      ...
      if (prop && typeof prop === 'object') {
        ...
        var _e = stateProps[i],
            active_1 = _e.active,
            hover = _e.hover,
            newProps = __rest(_e, ["active", "hover"]);
  ...
  var _f = mergeProps(matchedProps, buttonProps, hoverProps),
      color = _f.color,
      propsWithoutColor = __rest(_f, ["color"]);

  return React__default.createElement(FocusRing, {
    focusRingClass: "sl-focus-ring",
    autoFocus: autoFocus
  }, React__default.createElement(Box, __assign({
    as: defaultElement$3,
    px: sizes$1[size].px,
...
var ModalWrapper = function ModalWrapper(_a) {
  ...
  var modalProps = useModal().modalProps; // Get props for the dialog

  var _b = useDialog({}, ref),
      dialogProps = _b.dialogProps,
      titleProps = _b.titleProps; // TODO: having to pull out color for the typings is so annoying...


  var _c = mergeProps(overlayProps, modalProps),
      color = _c.color,
      containerProps = __rest(_c, ["color"]);
  ...
  if (isDraggable) {
    return React__default.createElement(DraggableModalBox, {
      ref: ref,
      onClose: onClose,
  ...
  return React__default.createElement(StaticModalBox, {
    ref: ref,
    onClose: onClose,
    containerProps: containerProps,
    dialogProps: dialogPropsWithoutColor,
...
var ModalBox = forwardRef(function (_a, ref) {
  ...
  return React__default.createElement(Box, __assign({}, containerProps, {
    bg: "canvas-dialog",
    boxShadow: "lg",
    rounded: true,
    pos: "relative",
    ...
    contain: !isDraggable
  }, React__default.createElement(Box, __assign({}, dialogProps, {
    ref: ref,
    "aria-describedby": dialogProps['aria-labelledby'] + "-body",
    "aria-modal": "true",
    "data-testid": "modal"
  }), React__default.createElement(Flex, __assign({}, moveProps, {
    borderB: true,
  ...
  }), typeof title === 'string' ? React__default.createElement(Heading, __assign({
    size: 3,
    fontSize: "xl",
    flex: 1
  }, titleProps), title) : React__default.createElement(Box, __assign({}, titleProps, {
    as: "header"
  }), title), !isNotDismissable && React__default.createElement(Button, {
    appearance: "minimal",
...
var ModalContent = memo(function (_a) {
  var children = _a.children,
      id = _a.id;
  return React__default.createElement(Box, {
    p: 5,
...
var StaticModalBox = forwardRef(function (props, ref) {
  ...
  return React__default.createElement(Flex, {
    ...
    zIndex: 40,
    pin: true
  }, React__default.createElement(Underlay, null), React__default.createElement(ModalBox, __assign({}, props, {
    ref: ref
  })));
});
var DraggableModalBox = forwardRef(function (props, ref) {
  var _a = __read(React__default.useState({
    x: 0,
    y: 0
  }), 2),
      position = _a[0],
  ...
  var _b = __read(useSize(ref), 2),
      modalWidth = _b[0],
      modalHeight = _b[1];

  var _c = __read(useWindowSize(), 2),
      windowWidth = _c[0],
      windowHeight = _c[1];
  ...
  return React__default.createElement(ModalBox, __assign({}, props, {
    moveProps: moveProps,
    position: position,
    ref: ref,
    isHidden: !modalWidth
...
var EntityName = memo(forwardRef(function EntityName(props, ref) {
  ...
  if (isIconEntityName(props)) {
    ...
    leftElem = React__default.createElement(Avatar, __assign({
      size: sizes$3[size].avatarSize,
      mx: "auto"
    }, avatar));
  }

  return React__default.createElement(Flex, __assign({}, rest, {
    ref: ref,
    align: "center",
...
var Input = memo(forwardRef(function Input(_a, ref) {
  ...
  var stateProps = __assign(__assign(__assign(__assign({}, variants$1["default"]["default"]), variants$1["default"][intent]), variants$1[appearance]["default"]), variants$1[appearance][intent]);
  ...
  return React__default.createElement(Box, __assign({
    ...
    icon: icon
  }) : null, React__default.createElement(Box, __assign({
    as: Input$1,
...
var NoSsr = function NoSsr(props) {
  ...
  var _c = __read(React__default.useState(false), 2),
      mountedState = _c[0],
...
var MenuItem = forwardRef(function MenuItem(_a, ref) {
  ...
  var elem = React__default.createElement(Flex, __assign({
    ref: ref
  }, props, {
    bg: bg,
    color: color,
  ...
  }), (indent || checked !== void 0) && React__default.createElement(Box, {
    style: {
      width: 20
    },
    flexShrink: 0,
    ...
    size: "sm"
  })) : null, meta && React__default.createElement(Box, {
    opacity: __active ? undefined : 60
...
var MenuRadioGroup = forwardRef(function MenuRadioGroup(_a, ref) {
  ...
  return React__default.createElement(Box, __assign({
    ...
    return React__default.createElement(MenuItem$1, __assign({}, __menu, item.props, {
      key: i,
      style: {
        outline: 0
      },
      ...
      return React__default.cloneElement(item, __assign(__assign({}, itemProps), {
...
var Menu = function Menu(props) {
  return React__default.createElement(NoSsr, null, React__default.createElement($Menu, __assign({
...
var $Menu = memo(forwardRef(function Menu(_a, ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(MenuButton, __assign({
    ref: ref
    ...
    return React__default.cloneElement(trigger, __assign(__assign(__assign({}, restDisclosureProps), handlerProp), {
...
var MenuContent = function MenuContent(_a) {
  ...
  var _b = __read(React__default.useState(menu.visible), 2),
      shouldRender = _b[0],
  ...
  var items = React__default.Children.toArray(children);
  return React__default.createElement(Menu$1, __assign({}, menu, {
    style: {
      outline: 0,
      zIndex: 10
    },
    ...
    if (item.type === MenuItem) {
      var _a = item.props,
          ...
          label_1 = _a.label,
          restItemProps_1 = __rest(_a, ["children", "disabled", "onClick", "label"]);
      ...
      if (children_1) {
        ...
        return React__default.createElement(MenuItem$1, __assign({}, menu, {
          key: i,
          as: $Menu,
          menuStateOpts: {
            loop: true,
          ...
          trigger: React__default.createElement(MenuItem, __assign({}, restItemProps_1, {
            disabled: disabled,
            __hasSubmenu: true
          })),
          disabled: disabled,
      ...
      return React__default.createElement(MenuItem$1, __assign({}, menu, restItemProps_1, {
        key: i,
        style: {
          outline: 0
        },
    ...
    if (item.type === MenuRadioGroup) {
      return React__default.createElement(MenuGroup, __assign({}, menu, item.props, {
        key: i
      }), function (itemProps) {
        return React__default.cloneElement(item, __assign(__assign({}, itemProps), {
          __menu: menu
...
var MenuOption = forwardRef(function MenuOption(props, ref) {
  return React__default.createElement(MenuItem, __assign({
    ref: ref,
    indent: true
  }, props));
});
...
var PanelTitlebar = memo(function (_a) {
  ...
  return React__default.createElement(FocusRing, {
    focusRingClass: "sl-focus-ring"
  }, React__default.createElement(Flex, __assign({
    ...
    h: "lg",
    onClick: onClick
  }, icon && React__default.createElement(Box, __assign({}, iconVariants[appearance]), icon), children), rightComponent));
});
...
var Panel = function Panel(_a) {
  ...
  var _e = __read(useControllableState({
    value: isOpenProp,
  ...
  var _f = __read(React__default.Children.toArray(children)),
...
var Popover = forwardRef(function (props, ref) {
  ...
  var positionProps = useOverlayPosition({
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(PressResponder, __assign({}, triggerProps, {
    ...
    isOpen: state.isOpen
  }, React__default.createElement(PopoverWrapper, __assign({}, overlayProps, positionProps, {
    ref: popoverRef,
    isOpen: state.isOpen,
    onClose: state.close,
    p: p
...
var PopoverWrapper = forwardRef(function (_a, ref) {
  ...
  var dialogProps = useDialog({}, domRef).dialogProps;

  var _c = mergeProps(overlayProps, dialogProps, otherProps, modalProps),
      color = _c.color,
      containerProps = __rest(_c, ["color"]);
  ...
  return React__default.createElement(FocusScope, {
    ...
    focusRingClass: "sl-focus-ring"
  }, React__default.createElement(Box, __assign({}, containerProps, {
    p: p,
    bg: "canvas-dialog",
    boxShadow: "lg",
    rounded: true,
...
var Tab = memo(function (_a) {
  var _b;

  var children = _a.children,
      id = _a.id,
      disabled = _a.disabled,
      restProps = __rest(_a, ["children", "id", "disabled"]);

  var _c = useTabContext(),
      isEager = _c.isEager,
      tab = __rest(_c, ["isEager"]);

  var tabRef = useRef();
  var isSelected = tab.selectedId === ((_b = tabRef.current) === null || _b === void 0 ? void 0 : _b.id);
  var disabledProps = {};

  if (disabled) {
    disabledProps.opacity = 40;
  }

  return createElement(FocusRing, {
    focusRingClass: "sl-focus-ring"
  }, createElement(Box, __assign({
    as: Tab$1,
    ref: tabRef,
    fontWeight: "medium",
    ...
    disabled: disabled,
    focusable: !disabled,
    color: isSelected ? 'body' : 'light'
  }, tab, disabledProps, sizes$6[tab.size], restProps), children));
});
...
var HStack = forwardRef(function (props, ref) {
  return React__default.createElement(Stack, __assign({
    align: "center"
  }, props, {
    ref: ref,
...
var TabList = function TabList(props) {
  var _a = useTabContext(),
      isEager = _a.isEager,
      tab = __rest(_a, ["isEager"]);

  return createElement(TabList$1, __assign({
    className: "sl-tabs__list",
    as: Stack,
    "aria-label": tab.baseId
  }, props, tab, {
    spacing: 2,
    justify: tab.orientation === 'horizontal' ? tab.align : undefined,
    align: tab.orientation === 'horizontal' ? 'start' : undefined,
    direction: tab.orientation
  }));
};

var TabPanel = memo(function (_a) {
  var children = _a.children,
      props = __rest(_a, ["children"]);

  var _b = useTabContext(),
      isEager = _b.isEager,
      tab = __rest(_b, ["isEager"]);

  var ref = useRef();
  var panel = tab.panels.find(function (panel) {
    var _a, _b;

    return ((_a = panel.ref.current) === null || _a === void 0 ? void 0 : _a.id) === ((_b = ref.current) === null || _b === void 0 ? void 0 : _b.id);
  });
  var showChildren = isEager ? true : (panel === null || panel === void 0 ? void 0 : panel.groupId) === tab.selectedId;
  return createElement(Box, __assign({
    as: TabPanel$1,
    ref: ref,
    className: "sl-tabs__panel"
  }, tab, {
    tabIndex: -1
  }, props), showChildren ? children : null);
});
...
var Tabs = function Tabs(_a) {
  var children = _a.children,
      ...
      isEager = _a.isEager;
  var oldSelectedId = usePrevious(selectedId);
  var tab = useTabState({
  ...
  }, [tab, size, align, isEager]);
  useEffect(function () {
    // Update selected tab whenever selectedId prop changes
    if (oldSelectedId !== selectedId) {
      tab.setSelectedId(selectedId);
    }
  }, [oldSelectedId, selectedId, tab]);
  useEffect(function () {
    // Only call onChange when internal tab state changes such as when Tab is clicked
    if (onChange && tab.selectedId !== selectedId && oldSelectedId === selectedId) {
      onChange(tab.selectedId);
    }
  }, [onChange, oldSelectedId, tab.selectedId, selectedId]);
...
var Tooltip = function Tooltip(props) {
  ...
  return React__default.createElement(FocusableProvider, __assign({}, triggerProps, {
    ...
    isOpen: state.isOpen
  }, React__default.createElement(TooltipWrapper, __assign({}, tooltipProps, positionProps, {
    placement: placement,
    ref: overlayRef,
    state: state,
    hideArrow: hideArrow
...
var computeArrowPosition = function computeArrowPosition(placement) {
  ...
  var _a = __read((placement || 'bottom').split(' '), 2),
      first = _a[0],
      second = _a[1];
...
function Select(_a) {
  ...
  var flexGrow = _a.flexGrow,
      ...
      defaultSelectedValue = _a.defaultSelectedValue,
      onSelectionChange = _a.onSelectionChange,
      allowEmptySelection = _a.allowEmptySelection,
      _d = _a.placeholder,
      ...
      props = __rest(_a, ["flexGrow", "w", "size", "label", "renderTrigger", "triggerTextPrefix", "items", "selectedValue", "defaultSelectedValue", "onSelectionChange", "allowEmptySelection", "placeholder", "onOpen", "onClose", "isReadOnly", "isDisabled", "children", "disabledValues"]);
  ...
  }, [onSelectionChange]); // Create state based on the incoming props
  ...
  var _f = __read(useSize(triggerRef), 1),
      buttonWidth = _f[0];
  ...
  var triggerElem = renderTrigger ? runIfFn(renderTrigger, __assign(__assign({}, triggerProps), {
    placeholder: placeholder
  }), {
    selectedItem: (_c = state.selectedItem) === null || _c === void 0 ? void 0 : _c.props
  }) : React__default.createElement(FieldButton, __assign({}, triggerProps, {
    size: size,
    disabled: isDisabled || isReadOnly,
    placeholder: placeholder,
    onClear: allowEmptySelection ? clearSelection : undefined
  ...
  }, React__default.createElement(ListBoxPopup, __assign({}, menuProps, {
    ref: listboxRef,
    label: label,
    items: items,
    state: state,
...
var ListBoxPopup = forwardRef(function (_a, ref) {
  var state = _a.state,
      ...
      label = _a.label,
      items = _a.items,
      otherProps = __rest(_a, ["state", "minW", "label", "items"]); // Get props for the listbox


  var listBoxProps = useListBox(__assign({
    autoFocus: 'first',
  ...
  }), React__default.createElement(Box, __assign({}, restProps, {
    ref: ref,
    py: 2,
    noFocusRing: true,
    overflowY: "auto",
  ...
  }), __spread(state.collection).map(function (item) {
    var type = item.type;
...
var Section = memo(function (_a) {
  ...
  var _b = useListBoxSection({
    ...
    'aria-label': item['aria-label']
      ...
      _c = _b.headingProps,
      color1 = _c.color,
      headingPropsWithoutColor = __rest(_c, ["color"]),
  ...
  var _d = useSeparator({
    elementType: 'li'
      ...
      color2 = _d.color,
      separatorPropsWithoutColor = __rest(_d, ["color"]);

  return React__default.createElement(React__default.Fragment, null, item.key !== state.collection.getFirstKey() && React__default.createElement(Box, __assign({}, separatorPropsWithoutColor, {
    my: 2,
    borderT: true,
    borderColor: isDark ? 'input' : undefined
  })), React__default.createElement("div", __assign({}, itemProps), item.rendered && React__default.createElement(Box, __assign({}, headingPropsWithoutColor, {
    pl: 7,
    ...
    cursor: "default",
    fontSize: "sm"
  }), item.rendered), React__default.createElement("div", __assign({}, groupProps), __spread(item.childNodes).map(function (node) {
    var item;
...
var SelectItem = memo(function (_a) {
  var item = _a.item,
...
SelectAction.getCollectionNode = function getCollectionNode(props) {
  ...
  return __generator(this, function (_a) {
    switch (_a.label) {
      case 0:
        text = props.text;
        textValue = text || props['aria-label'] || '';
        return [4
        /*yield*/
        , {
          type: 'item',
...
SelectOption.getCollectionNode = function getCollectionNode(props) {
  ...
  return __generator(this, function (_a) {
    switch (_a.label) {
      case 0:
        value = props.value, text = props.text;
        textValue = (typeof text === 'string' ? text : '') || props['aria-label'] || value || '';
        return [4
        /*yield*/
        , {
          type: 'item',
