...
export declare const CodeContainer: React.NamedExoticComponent<import("@stoplight/mosaic").ITypographyProps & import("@stoplight/mosaic").ISizeProps & import("@stoplight/mosaic").IMarginProps & import("@stoplight/mosaic").IPaddingProps & import("@stoplight/mosaic").IShadowProps & import("@stoplight/mosaic").IColorProps & import("@stoplight/mosaic").IBorderProps & import("@stoplight/mosaic").IRingProps & import("@stoplight/mosaic").IInteractivityProps & import("@stoplight/mosaic").IFlexProps & import("@stoplight/mosaic").IPositionProps & import("@stoplight/mosaic").ILayoutProps & {
    as?: React.ElementType<any>;
    className?: string;
    role?: string;
    noFocusRing?: boolean;
} & Omit<any, keyof import("@stoplight/mosaic").ITypographyProps | keyof import("@stoplight/mosaic").ISizeProps | keyof import("@stoplight/mosaic").IMarginProps | keyof import("@stoplight/mosaic").IPaddingProps | "boxShadow" | keyof import("@stoplight/mosaic").IColorProps | keyof import("@stoplight/mosaic").IBorderProps | keyof import("@stoplight/mosaic").IRingProps | keyof import("@stoplight/mosaic").IInteractivityProps | keyof import("@stoplight/mosaic").IFlexProps | keyof import("@stoplight/mosaic").IPositionProps | keyof import("@stoplight/mosaic").ILayoutProps | "as" | "className" | "role" | "noFocusRing"> & {
    renderHighlight: () => JSX.Element;
    maxHeight?: number;
