(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react/jsx-runtime'), require('prism-react-renderer/prism'), require('@stoplight/mosaic'), require('clsx'), require('prism-react-renderer'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react/jsx-runtime', 'prism-react-renderer/prism', '@stoplight/mosaic', 'clsx', 'prism-react-renderer', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CodeViewer = {}, global.jsxRuntime, global.ReactRendererPrism, global.mosaic, global.cn, global.PrismHighlight, global.React));
})(this, (function (exports, jsxRuntime, ReactRendererPrism, mosaic, cn, PrismHighlight, React) { 'use strict';
  ...
  */
  ...
  const _excluded = ["value", "className", "language", "customLanguage", "showLineNumbers", "showMaxLines", "title", "noCopyButton", "highlightPadding"],
        _excluded2 = ["title", "children", "maxHeight", "innerProps", "renderHighlight", "lines", "copyValue", "highlightPadding", "language"],
  ...
  const CodeViewer = /*#__PURE__*/React.memo(_ref => {
    let {
      value,
      className,
      language,
  ...
  const useHighlight = ({
    ...
    const [actualMaxLines, setActualMaxLines] = React__namespace.useState(_showMaxLines);
    const {
      code,
      loc: lines,
      trimmed
    ...
    return {
      ...
      renderHighlight: () => jsxRuntime.jsx(PrismHighlight__default["default"], {
        code: code,
        ...
        children: ({
          ...
          children: [jsxRuntime.jsx(mosaic.Box, {
            UNSAFE_className: cn__default["default"]('sl-code-highlight', className),
            style: Object.assign({}, style, propStyle),
            children: tokens.map((line, i) => {
              var _a;

              return jsxRuntime.jsxs(mosaic.Box, Object.assign({}, getLineProps({
                line,
                key: i
              }), {
                display: "flex",
                children: [showLineNumbers ? jsxRuntime.jsx(mosaic.Box, {
                  ...
                  children: i + 1
                }, void 0) : null, jsxRuntime.jsx(mosaic.Box, {
                  flex: 1,
                  wordBreak: "all",
          ...
          }, void 0), trimmed ? jsxRuntime.jsx(ShowMoreLessButton, {
            icon: "arrow-down",
            onClick: () => setActualMaxLines(-1),
            children: "show more"
          }, void 0) : _showMaxLines !== actualMaxLines ? jsxRuntime.jsx(ShowMoreLessButton, {
            icon: "arrow-up",
  ...
  const HighlightCodeFallback = ({
    ...
    return jsxRuntime.jsx(mosaic.Box, {
  ...
  const CodeContainer = /*#__PURE__*/React.memo(function CodeContainer(_ref2) {
    let {
      title,
      maxHeight = 500,
      innerProps = {},
    ...
    return jsxRuntime.jsxs(mosaic.Box, Object.assign({
      ...
      children: [title && jsxRuntime.jsx(mosaic.Box, {
        ...
        children: jsxRuntime.jsx(mosaic.NoSsr, {
          fallback: jsxRuntime.jsx(HighlightCodeFallback, {
            lines: lines,
            highlightPadding: highlightPadding
          }, void 0),
          children: jsxRuntime.jsx(CodeContainerRenderHighlight, {
            renderHighlight: renderHighlight
          }, void 0)
        }, void 0)
  ...
  const ShowMoreLessButton = _ref3 => {
    let {
      children,
      icon
    } = _ref3,
    ...
    return jsxRuntime.jsxs(mosaic.Box, Object.assign({
      ...
      children: [jsxRuntime.jsx(mosaic.Box, {
        ...
        icon: icon
      }, void 0), jsxRuntime.jsx(mosaic.Box, {
        as: "span",
        px: 2,
        fontWeight: "medium",
        children: children
