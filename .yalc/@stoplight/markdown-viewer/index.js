...
const DefaultSMDComponents = {
    a: (_a) => {
        ...
        if (!href)
            return null;
        if (href.startsWith('/')) {
            return React__default['default'].createElement("a", Object.assign({ href: href }, props));
        }
        return React__default['default'].createElement("a", Object.assign({ href: href, target: "_blank", rel: "noopener noreferrer" }, props));
    },
    h1: (_a) => {
        var props = __rest(_a, ["color"]);
        return React__default['default'].createElement(mosaic.Heading, Object.assign({ size: 1 }, props));
    },
    h2: (_a) => {
        var props = __rest(_a, ["color"]);
        return React__default['default'].createElement(mosaic.LinkHeading, Object.assign({ size: 2 }, props));
    },
    h3: (_a) => {
        var props = __rest(_a, ["color"]);
        return React__default['default'].createElement(mosaic.LinkHeading, Object.assign({ size: 3 }, props));
    },
    h4: (_a) => {
        var props = __rest(_a, ["color"]);
        return React__default['default'].createElement(mosaic.LinkHeading, Object.assign({ size: 4 }, props));
    },
    h5: (_a) => {
        var props = __rest(_a, ["color"]);
        return React__default['default'].createElement(mosaic.Heading, Object.assign({ size: 4 }, props));
    },
    h6: (_a) => {
        var props = __rest(_a, ["color"]);
        return React__default['default'].createElement(mosaic.Heading, Object.assign({ size: 4 }, props));
    },
    blockquote: ({ theme, children }) => (React__default['default'].createElement("blockquote", { className: `sl-blockquote--${theme || 'default'}` }, children)),
    img: (_a) => {
        var { src, color: _color, bg, focus } = _a, props = __rest(_a, ["src", "color", "bg", "focus"]);
        if (!src)
            return null;
        return (React__default['default'].createElement(mosaic.ProductImage, { bg: bg, focus: focus },
            React__default['default'].createElement(mosaic.Image, Object.assign({ src: src }, props))));
    },
    code: ({ children, inline, lineNumbers, title, lang }) => {
        ...
        return (React__default['default'].createElement(reactErrorBoundary.ErrorBoundary, null,
            React__default['default'].createElement(mosaic.InvertTheme, null,
                React__default['default'].createElement(mosaicCodeViewer.CodeViewer, { bg: "canvas", value: String(children), language: getCodeLanguage(String(lang)), rounded: "lg", ring: { focus: true }, ringColor: "primary", ringOpacity: 50, showLineNumbers: lineNumbers !== void 0, title: title }))));
    },
    tabs: props => {
            ...
            React__default['default'].createElement(mosaic.Tabs, null,
                React__default['default'].createElement(mosaic.Flex, { alignItems: "center" },
                    ...
                    React__default['default'].createElement(mosaic.TabList, { fontSize: "lg", density: "compact" }, React__default['default'].Children.map(props.children, (child, i) => {
                        ...
                        return React__default['default'].createElement(mosaic.Tab, { key: i }, ((_b = children === null || children === void 0 ? void 0 : children.props) === null || _b === void 0 ? void 0 : _b.lang) || 'untitled');
                    }))),
...
const Preprocessor = preprocessor$1;
...
function visitParents$3(tree, test, visitor, reverse) {
  ...
  function one(node, index, parents) {
    ...
    if (node.children && result[0] !== SKIP$3) {
      ...
      return subresult[0] === EXIT$3 ? subresult : result
    }
...
function merge$2(definitions) {
  ...
  return new Schema$1(
    xtend$2.apply(null, property),
    xtend$2.apply(null, normal),
    space
  )
}
...
var svg_1$1 = merge$1([xml$2, xlink$2, xmlns$2, aria$1, svg$5]);
...
var hastUtilParseSelector = parse$6;

var numberSign = 35; //  '#'
var dot$1 = 46; //  '.'

// Create a hast element from a simple CSS selector.
function parse$6(selector, defaultTagName) {
  var value = selector || '';
  ...
  while (++index <= length) {
    ...
    if (!code || code === dot$1 || code === numberSign) {
...
spaceSeparatedTokens.parse = parse$5;
...
commaSeparatedTokens.parse = parse$4;
...
function toH$2(h, node, ctx) {
  ...
  if (ctx.vdom) {
    if (schema.space === 'html') {
      ...
      attributes.namespace = ns$2[schema.space];
    }
  }
...
function addAttribute(props, prop, value, ctx, name) {
  var info = find$1(ctx.schema, prop);
  var subprop;
...
function element(node, schema) {
  ...
  var shallow = xtend$1(node, {children: []});

  return toH$1(h, shallow, {space: space})
  ...
  function h(name, attrs) {
    ...
    for (key in attrs) {
      ...
      if (info.space && ignoredSpaces.indexOf(info.space) === -1) {
        ...
        value.namespace = ns$1[info.space];
      }
...
function patch(node, p5, parentSchema) {
  ...
  if (node.type === 'element') {
    ...
    p5.namespaceURI = ns$1[schema.space];
  }
...
const mdast2React = (input, opts = {}) => {
    const processorInstance = createMdastToHastProcessor(opts).use(rehypeReact_1, {
...
const markdown2React = (input, opts = {}) => {
    const processed = createHastProcessor(opts)
        .use(rehypeReact_1, { createElement: React.createElement, Fragment: React.Fragment, components: opts.components })
        .processSync(input);
    return processed.result;
};
const parse = markdown.parse;
...
const useMarkdownTree = (markdownOrTree, opts = {}) => {
    return React__default['default'].useMemo(() => typeof markdownOrTree === 'string' ? markdown2React(markdownOrTree, opts) : mdast2React(markdownOrTree, opts), [markdownOrTree, opts]);
};
...
const MarkdownViewer = (_a) => {
    ...
    return (React__default['default'].createElement(reactErrorBoundary.ErrorBoundary, { onError: onError, FallbackComponent: FallbackComponent },
        React__default['default'].createElement(MarkdownViewerComponent, Object.assign({}, props))));
};
...
const MarkdownViewerComponent = (_a) => {
    ...
    const componentMapping = React__default['default'].useMemo(() => (Object.assign(Object.assign({}, DefaultSMDComponents), components)), [components]);
    const tree = useMarkdownTree(markdownOrTree, Object.assign(Object.assign({}, parseOptions), { components: componentMapping }));
    return (React__default['default'].createElement(mosaic.Prose, Object.assign({ className: "sl-markdown-viewer" }, props), tree));
};
