import { Heading, LinkHeading, ProductImage, Image, Code, InvertTheme, Tabs, TabList, Tab, TabPanels, TabPanel, Box, Flex, Icon, Prose } from '@stoplight/mosaic';
...
const DefaultSMDComponents = {
    ...
    img: (_a) => {
        ...
        if (!src)
            return null;
        return (React.createElement(ProductImage, { bg: bg, focus: focus },
            React.createElement(Image, Object.assign({ src: src }, props))));
    },
