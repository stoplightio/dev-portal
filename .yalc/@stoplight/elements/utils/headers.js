...
exports.allHeaderFields = exports.formatMultiValueHeader = void 0;
...
exports.formatMultiValueHeader = formatMultiValueHeader;
exports.allHeaderFields = [
    {
        name: 'A-IM',
    ...
    {
        name: 'Connection',
        description: 'Control options for the current connection and list of hop-by-hop request fields.[12]Must not be used with HTTP/2.[13]',
    ...
    {
        name: 'Host',
        description: 'The domain name of the server (for virtual hosting), and the TCP port number on which the server is listening. The port number may be omitted if the port is the standard port for the service requested.Mandatory since HTTP/1.1.[16] If the request is generated directly in HTTP/2, it should not be used.[17]',
    ...
    {
        name: 'Prefer',
        description: 'Used to request that certain behaviours be employed by a server while processing a request. Used by Prism to control some of the behaviour of the mock server.',
    ...
    },
    {
        ...
        description: 'Tells a server which (presumably in the middle of a HTTP -> HTTPS migration) hosts mixed content that the client would prefer redirection to HTTPS and can handle Content-Security-Policy: upgrade-insecure-requestsMust not be used with HTTP/2[13]',
    ...
    {
        name: 'DNT',
        description: "Requests a web application to disable their tracking of a user. This is Mozilla's version of the X-Do-Not-Track header field (since Firefox 4.0 Beta 11).Safari and IE9 also have support for this field.[22] On March 7, 2011, a draft proposal was submitted to IETF.[23] The W3C Tracking Protection Working Group is producing a specification.[24]",
    ...
    },
    {
        ...
        description: 'Implemented as a misunderstanding of the HTTP specifications. Common because of mistakes in implementations of early HTTP versions. Has exactly the same functionality as standard Connection field.Must not be used with HTTP/2.[13]',
