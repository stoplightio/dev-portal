...
const SchemaAndDescription = ({ className, title, description, schema, errors, viewMode, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(json_schema_viewer_1.JsonSchemaViewer, { resolveRef: resolveRef, className: classnames_1.default(className, markdown_viewer_1.CLASSNAMES.block), schema: Object.assign(Object.assign({}, schema), { title: undefined, description: undefined }), viewMode: viewMode })));
};
...
//# sourceMappingURL=SchemaAndDescription.js.map