...
exports.useTocContents = exports.OPERATION_REGEXP = exports.MODEL_REGEXP = exports.MARKDOWN_REGEXP = void 0;
...
function computeToc(items, { operationMap, parentId, depth = 0, }) {
    ...
    for (const nodeIndex in items) {
        ...
        if (tocNode.type === 'item') {
            ...
            const isModel = exports.MODEL_REGEXP.test(tocNode.uri) ||
...
function getOperationForUri(uri, operationMap) {
    if (operationMap) {
        ...
        const match = exports.OPERATION_REGEXP.exec(uri);
