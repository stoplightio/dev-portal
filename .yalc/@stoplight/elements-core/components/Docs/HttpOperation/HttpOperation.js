...
const HttpOperationComponent = React.memo(({ className, data, headless, uri, hideTryIt, hideTryItPanel }) => {
    ...
    if (!headless)
        return (React.createElement(mosaic_1.Box, { bg: "transparent", className: classnames_1.default('HttpOperation', className), w: "full" },
            ...
            React.createElement(mosaic_1.Flex, { mt: 12 },
                ...
                !hideTryItPanel && (React.createElement(mosaic_1.Box, { ml: 16, pos: "relative", w: "2/5", style: { maxWidth: 500 } },
                    React.createElement(mosaic_1.Box, { className: "HttpOperation__gutter" },
                        React.createElement(TryIt_1.TryItWithRequestSamples, { httpOperation: data, responseMediaType: responseMediaType, responseStatusCode: responseStatusCode, requestBodyIndex: requestBodyIndex, hideTryIt: hideTryIt, mockUrl: mocking.hideMocking ? undefined : mocking.mockUrl })))))));
