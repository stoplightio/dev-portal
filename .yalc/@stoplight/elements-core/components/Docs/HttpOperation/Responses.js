...
const Responses = ({ responses: unsortedResponses, onStatusCodeChange, onMediaTypeChange }) => {
    ...
    return (React.createElement(mosaic_1.Tabs, { selectedId: activeResponseId, onChange: setActiveResponseId },
        React.createElement(mosaic_1.Box, null,
            ...
            React.createElement(mosaic_1.Box, { as: mosaic_1.TabPanels, mt: 4 }, responses.map(response => (React.createElement(mosaic_1.TabPanel, { key: response.code, id: response.code },
