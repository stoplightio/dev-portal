...
describe('HttpOperation', () => {
    describe('Header', () => {
        ...
        it('displays scopes in badge when present', () => {
            ...
            const { unmount } = react_1.render(React.createElement(HttpOperation, { data: Object.assign(Object.assign({}, put_todos_1.default), { security }) }));
    ...
    describe('Visibility', () => {
        it('should hide TryIt', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            react_1.render(React.createElement(HttpOperation, { data: put_todos_1.default, hideTryIt: true }));
            expect(dom_1.screen.queryByText('Send Request')).not.toBeInTheDocument();
            expect(yield dom_1.screen.findByText('Response Example')).toBeInTheDocument();
        }));
        it('should hide right column', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            react_1.render(React.createElement(HttpOperation, { data: put_todos_1.default, hideTryItPanel: true }));
            expect(dom_1.screen.queryByText('Send Request')).not.toBeInTheDocument();
            expect(dom_1.screen.queryByText('Response Example')).not.toBeInTheDocument();
        }));
    });
});
