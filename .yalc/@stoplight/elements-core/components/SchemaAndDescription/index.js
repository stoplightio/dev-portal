...
const SchemaAndDescription = ({ className, title, description, schema, errors, viewMode, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(json_schema_viewer_1.JsonSchemaViewer, { resolveRef: resolveRef, className: classnames_1.default(className), schema: schema, viewMode: viewMode })));
};
