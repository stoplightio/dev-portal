...
describe('TryItWithRequestSamples', () => {
    ...
    it('displays base url correctly', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        react_1.render(React.createElement(TryItWithRequestSamples, { httpOperation: with_url_variables_1.operationWithUrlVariables }));
        const codeViewer = yield react_1.screen.findByLabelText(/curl/);
