...
const TryIt = ({ httpOperation, mockUrl, onRequestChange, requestBodyIndex }) => {
    var _a, _b, _c, _d, _e;
    ...
    return (React.createElement(mosaic_1.Box, { rounded: "lg", overflowY: "hidden" },
        React.createElement(mosaic_1.Panel, { isCollapsible: false, className: "p-0 TryItPanel" },
            ...
            React.createElement(mosaic_1.Panel.Content, { className: "SendButtonHolder" },
                React.createElement(mosaic_1.Flex, { alignItems: "center" },
                    ...
                    mockUrl && (React.createElement(MockingButton_1.MockingButton, { options: mockingOptions, onOptionsChange: setMockingOptions, operation: httpOperation }))))),
