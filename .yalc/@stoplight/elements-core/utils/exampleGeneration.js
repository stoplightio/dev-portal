...
const useGenerateExampleFromMediaTypeContent = (mediaTypeContent, chosenExampleIndex) => {
    ...
    return react_1.default.useMemo(() => exports.generateExampleFromMediaTypeContent(mediaTypeContent, document, chosenExampleIndex), [mediaTypeContent, document, chosenExampleIndex]);
};
